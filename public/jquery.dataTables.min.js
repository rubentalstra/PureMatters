    ...
    function Jb(a) {
        ...
        for (b = g.length; k < b; k++) {
            ...
            a.oFeatures.bSort &&
                ...
                !1 !== m.bSortable &&
                    (n.attr('tabindex', a.iTabIndex).attr('aria-controls', a.sTableId), kb(a, m.nTh, k)));
            ...
            if (0 !== k.length) {
                ...
                (e = f.sZeroRecords),
                    ...
                    (c[0] = l('<tr/>', { class: h ? d[0] : '' }).append(
                        l('<td />', { valign: 'top', colSpan: na(a), class: a.oClasses.sRowEmpty }).html(e)
                    )[0]);
            }
    ...
    z('destroy()', function (a) {
        ...
        return this.iterator('table', function (b) {
            ...
            l('th, td', h).removeClass(
                c.sSortable + ' ' + c.sSortableAsc + ' ' + c.sSortableDesc + ' ' + c.sSortableNone
            );
            e.children().detach();
            e.append(m);
